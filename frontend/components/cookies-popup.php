<div id="cookies-popup-overlay">
    <div id="cookies-popup">
        <div id="cookies-popup-left">
            ...
            <div id="cookies-popup-btn-container">
                <a class="button" id="accept-cookies" href="/cookies/acceptCookies">Accepter les cookies</a>
                <a class="button" id="deny-cookies" href="/cookies/denyCookies">Refuser les cookies</a>
            </div>
        </div>
