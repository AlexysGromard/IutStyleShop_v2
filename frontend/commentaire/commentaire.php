...
<body>
    ...
    <main id="commentaire-main">
            ...
            <div class="commentaire-block commentaire-contenaire">
                <div class="commentaire-block form-commentaire">
                    ...
                    <div class="commentaire-block article-info-part">
                        ...
                        <div class="article-image article-grow1">
                            <img src="<?php echo $article->getImages()[0]; ?>" alt="produit" class="article-image">
                        </div>
                    
                        <div class="commentaire-block article-info article-grow9">

                            <p class="Black_police_60"><?php echo $article->getNom(); ?></p>

                            <div class="commentaire-block article-info-part ">
                                <div class="article-grow3">
                                    <p class="Black_police_40">Category: <?php echo $article->getCategory(); ?></p>
                                    <p class="Black_police_40">Taille  : <?  ?></p>
                                    <p class="Black_police_40">Couleur : <?php echo $article->getCouleur(); ?></p>
                                </div>
                                <div class="article-grow9" style="width: min-content;">
                                    ...
                                    <p class="Black_police_40"><?php echo $article->getVotant(); ?> évaluations</p>
                                </div>
                                
                                <div class="article-grow1">
                                    <p class="Black_police_40">Prix unitaire:</p>
                                    <p class="Black_police_60"><?php echo $article->getPrix(); ?>€</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <form action="/commentaire/addCommentaire/<?php echo $article->getId(); ?>" method="post" class="form-commentaire">
                    ...
                    <div class="form-commentaire-part">
                        ...
                        <input type="radio" name="note" id="note1" value="1" onclick="mettreEtoiles()" checked>
                        <label for="note1"><img src="/frontend/assets/icons/marquer-comme-star-preferee.svg" id="etoile0" alt="etoile"></label>
